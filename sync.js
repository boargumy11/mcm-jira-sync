...
async function sync() {
  ...
  // Jira Cloud REST API requires account ID in JQL, not email address
  const reporterAccountId = "712020:1d974ae6-5c60-4b5a-bcf1-58c2ab455b4e"; // gabriel_chou@lhwlfw.com

  const jql = `project = MCMARKET AND reporter = "${reporterAccountId}" ORDER BY created DESC`;
