 ...
 *   JIRA_REPORTER_EMAIL      Email of the reporter whose tickets should be fetched
 *                            e.g. gabriel_chou@lhwlfw.com
...
async function sync() {
    ...
    const reporterEmail = process.env.JIRA_REPORTER_EMAIL;

  const jql = `project = MCMARKET AND reporter = "${reporterEmail}" ORDER BY created DESC`;
